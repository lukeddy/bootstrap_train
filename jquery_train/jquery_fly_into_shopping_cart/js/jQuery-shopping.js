								...
								$obj.stop(false, false).animate({'top': Y-20,'opacity':0},500,function(){
									$obj.fadeOut(300,function(){
										...
										var l=$('.J-shoping-list').length,
											num=Number($num.text());
										if(l<5){
											$body.prepend('<div class="J-shoping-list" data-id="'+id+'"><a href="#"title=""><img src="images/pro1.jpg" width="50"height="50"/></a><div class="J-shoping-list-a"><p>荣耀手机</p><p><span class="left">哈哈</span><span class="right"><em>2200.0</em>吨</span></p></div><div class="baseBg J-shoping-close"></div></div>');
										};
										$num.text(num+1);
									});
								});
